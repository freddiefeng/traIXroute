...
class download_files():
    ...
    def download_files(self,mypath):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
            peering = executor.submit(self.download_peering, mypath, 0)
            pch = executor.submit(self.download_pch, mypath, 0)
            routeviews = executor.submit(self.download_routeviews, mypath)
    ...
    def download_peering(self,mypath,option):
        ...
        try:
            ...
            print('PDB dataset has not been updated.')
            return False
    ...
    def download_pch(self,mypath,option):
        ...
        if option==1 or not option:
            try:   
                ...
                print('ixp_subnets.csv has not been updated.')
                return False
        ...
        if option==2 or not option:
            try:
                ...
                print('ixp_exchange.csv has not been updated.')
                return False
        ...
        if option==3 or not option:
            try:
                ...
                print('ixp_membership.csv has not been updated.')
                return False
    ...
    def download_routeviews(self,mypath):
        ...
        try:
            ...
            print('RouteViews dataset has not been updated.')
            return False
        ...
        try:
            ...
            print('RouteViews has not been updated.')
            return False
